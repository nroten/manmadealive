    ...
    <footer className="relative py-20 sm:py-28 border-t border-border/30">
      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="font-sans text-sm text-muted-foreground text-center max-w-lg leading-relaxed">
            Man Made Alive is a formation pathway for Christian men — made fully alive in Christ, for the glory of God.
          </p>
